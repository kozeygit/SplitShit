...
export const mapBillToModel = (
    dbBill: typeof billsSchema.$inferSelect,
): Bill => {
    const mappedBill: Bill = {
        ...
        serviceCharge: Rate.fromBasisPoints(dbBill.serviceCharge),
        complete: Boolean(dbBill.complete),
        items: [],
        payers: [],
        groupId: dbBill.groupId || undefined,
        imagePath: dbBill.imagePath || undefined,
    };
    return mappedBill;
};

export const mapPayerToModel = (
    dbPayer: typeof payersSchema.$inferSelect,
    dbBillPayer?: typeof billPayersSchema.$inferSelect,
): Payer => {
...
export const mapGroupToModel = (
    dbGroup: typeof groupsSchema.$inferSelect,
): Group => {
...
export const mapBillItemToModel = (
    dbBillItem: typeof billItemsSchema.$inferSelect,
): BillItem => {
